...
int main()
{
	...
	{
		cout << "You will be fighting against a Charmander!\n\n";
	}
	else
	{
		cout << "You will be fighting against a Squirtle!\n\n";
	}
	...
	while (((*Player1).m_Health > 0) && ((*Player2).m_Health > 0))
	{
		...
		else if (!(*Player2).m_Conscious)
		{
			...
			{
				cout << "Your opponent Charmander is unable to move. Your opponent misses a turn.\n";
				srand(time(0));
				if (rand() % RECOVER_FACTOR != 0)
				{
					(*Player2).m_Conscious = true;
			...
			{
				cout << "Your opponent Squirtle is unable to move. Your opponent misses a turn.\n";
				srand(time(0));
				if (rand() % RECOVER_FACTOR != 0)
				{
					(*Player2).m_Conscious = true;
		...
		else
		{
			...
			{
				cout << "Congratulations! You've defeated your opponent Charmander.\n";
			}
			else
			{
				cout << "Congratulations! You've defeated your opponent Squirtle.\n";
			}
